...
export default function BeautifulCard ({
  ...
  return (
    <li
      ...
      className="relative cursor-pointer z-0 group overflow-hidden h-full border border-zinc-800 rounded-xl bg-[radial-gradient(500px_circle_at_var(--cursor-x)_var(--cursor-y),#22d3ee_0,transparent,transparent_70%)]"
    >
